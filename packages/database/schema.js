...
exports.imoveisRelations = exports.midiaImovel = exports.instrucoesChegada = exports.inventario = exports.infraestrutura = exports.imoveis = exports.statusImovelEnum = exports.tipoImovelEnum = void 0;
...
exports.imoveis = (0, pg_core_1.pgTable)("imoveis", {
    ...
    precoVenda: (0, pg_core_1.decimal)("preco_venda", { precision: 12, scale: 2 }),
    precoAluguel: (0, pg_core_1.decimal)("preco_aluguel", { precision: 12, scale: 2 }),
    valorIptu: (0, pg_core_1.decimal)("valor_iptu", { precision: 10, scale: 2 }),
    valorCondominio: (0, pg_core_1.decimal)("valor_condominio", { precision: 10, scale: 2 }),
...
exports.infraestrutura = (0, pg_core_1.pgTable)("infraestrutura", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    imovelId: (0, pg_core_1.integer)("imovel_id").references(() => exports.imoveis.id, {
        onDelete: "cascade",
    }),
...
exports.midiaImovel = (0, pg_core_1.pgTable)("midia_imovel", {
    ...
    tipo: (0, pg_core_1.varchar)("tipo", { length: 20 })
        .$type()
        .default("foto"),
